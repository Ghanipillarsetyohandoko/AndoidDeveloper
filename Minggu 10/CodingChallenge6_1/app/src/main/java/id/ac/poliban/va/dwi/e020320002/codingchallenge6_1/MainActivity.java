package id.ac.poliban.va.dwi.e020320002.codingchallenge6_1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Recycler View Espresso Test_096_ghani");
