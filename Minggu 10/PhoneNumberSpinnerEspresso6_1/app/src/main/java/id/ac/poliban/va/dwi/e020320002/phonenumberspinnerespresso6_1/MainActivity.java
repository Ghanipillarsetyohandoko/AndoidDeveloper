package id.ac.poliban.va.dwi.e020320002.phonenumberspinnerespresso6_1;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Phone Number Spinner Espresso_096_ghani");
    ...
    /**
     * Retrieves the text and spinner item and shows them in text_phone_label.
     *
