package id.ac.poliban.mi.ramlan.droidcafewithsettings_092;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.ramlan.droidcafewithsettings_092.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Droid Cafe_096");
